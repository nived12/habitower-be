...
Devise.setup do |config|
  ...
  # config.secret_key = '965c64aad58de6441b0f41709180cfeb7fc3c059037dc9f0b031ab37bb9f5bfb92da453e9f6458def0a9347e623884cbb68cf50a8baa433f2a65d513acdc96af' # rubocop:disable Layout/LineLength

  # ==> Controller configuration
  # Configure the parent class to the devise controllers.
  # API-only: use ApplicationController (ActionController::API) so Devise works without sessions.
  ...
  # API-only: skip all session storage; use JWT instead.
  config.skip_session_storage = %i[http_auth params_auth cookie]
  ...
  # config.pepper = '121b2ad49829034f385afa61c242b08c1461ce10c75a075cdb4ff16f5dc3ff14d0703ea9facaa6a31beb2464d8d5cc1b972542a4d05cd680e98b3ca7ebe1bc4c' # rubocop:disable Layout/LineLength
